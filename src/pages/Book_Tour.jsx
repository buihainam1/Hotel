...
const Book_Tour = () => {
  ...
  const showLess = () => {
   ...
   const [showAll, setShowAll] = useState(false);
     ...
     const data = config.tourImagees?.map((image) => ({
    ...
    return (
        <div>
            ...
            <div className="mx-auto max-w-screen-xl px-4 py-2 w-full mt-8 flex flex-col gap-5">
                ...
                <p className="font-bold text-[25px]">{config.tourName}</p>
        ...
        <IconButton variant="outlined">
          <img src="/img/share.png"/>
                ...
                <div className="flex flex-row w-ful gap-3 ">
                    ...
                    <img src={config.tourImagees[0].filePath}  className="w-full h-full object-cover rounded-tl-lg rounded-bl-lg"/>
                    {/* <img src={config.tourImagees[1].filePath}  className="w-full h-full object-cover rounded-tl-lg rounded-bl-lg"/> */}
                    </Carousel>
                    </div>
    <div  className="w-2/5">
        ...
        <div key={index}>
          ...
          />
                ...
                <div className="flex flex-row gap-3">
                    ...
                    <div className="w-2/5">
                    <Link to="/pages/enter_payment_tour">
